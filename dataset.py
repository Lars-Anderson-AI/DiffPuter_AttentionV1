...
DATA_DIR = '/kaggle/working/DiffPuter_Attention/datasets'

def load_dataset(dataname, idx = 0, mask_type = 'MCAR', ratio = '30'):
    data_dir = f'/kaggle/working/DiffPuter_Attention/datasets/{dataname}'
    info_path = f'/kaggle/working/DiffPuter_Attention/datasets/Info/{dataname}.json'
